...
- 生猪专题指标长表与核心宽表抽取
- 历史周报页面 raw html / raw text / meta 留痕落盘
- 历史周报指标长表与核心宽表抽取
- 日志、摘要、人工复核清单输出
...
- 抓取脚本：`scripts/moa_xm_weekly_crawler.py`
...
- 抓取摘要：`data/metadata/moa_xm_weekly_summary.json`
- 人工复核清单：`data/metadata/moa_xm_weekly_manual_review.csv`
